...
parameters.xml: ../src/morus_modules/morus_mmc_vpc_attitude_control/mmc_vpc_attitude_control_params.c
parameters.xml: ../src/morus_modules/morus_position_control/position_control_params.c
parameters.xml: ../src/morus_modules/morus_px4_controller_commander/controller_commander_params.c
parameters.xml: ../src/morus_modules/morus_rotors_variation_attitude_control/rotors_variation_attitude_control_params.c
...
parameters.xml: ../Tools/px_generate_params.py
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/lmark/src/px4-firmware/px4-firmware-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating parameters.xml"
	/usr/bin/python /home/lmark/src/px4-firmware/Tools/px_process_params.py -s /home/lmark/src/px4-firmware/src --board CONFIG_ARCH_sitl --xml --inject-xml --scope /home/lmark/src/px4-firmware/cmake/configs/posix_sitl_default.cmake

airframes.xml:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/lmark/src/px4-firmware/px4-firmware-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Generating airframes.xml"
	/usr/bin/python /home/lmark/src/px4-firmware/Tools/px_process_airframes.py -a /home/lmark/src/px4-firmware/ROMFS//init.d --board CONFIG_ARCH_BOARD_sitl --xml
